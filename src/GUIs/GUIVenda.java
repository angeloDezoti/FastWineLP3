...
public class GUIVenda extends JFrame {
    ...
    private JPanel pnDataVenda = new JPanel(new GridLayout(1, 2));
    ...
    public GUIVenda(Point posicao, Dimension dimensao) {
        setSize(900, 400);
        ...
        pnCentro.add(pnDataVenda);
        pnDataVenda.add(btEscolha2);
        pnDataVenda.add(tfDataVenda);
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    if (venda == null) {
                        ...
                        tfDataVenda.setText(sdf.format(venda.getData()));
        ...
        btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    data2 = sdf.parse(tfDataVenda.getText());
                    try {
                        venda.setData(sdf.parse(tfDataVenda.getText()));
        ...
        btEscolha2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    data2 = dc2.select();
                    tfDataVenda.setText(sdf.format(data2));
                } catch (Exception ex) {
    ...
    public static void main(String[] args) {
        new GUIVenda(new Point(880, 250), new Dimension(800, 600));
    }
